...
The set $A$ contains one element, and that element is the empty set.  The empty set is an element of $A$, but the empty set is not a subset of $A$.  The empty set is a subset of every set, but it is not an element of every set.  The empty set is an element of $A$, but it is not an element of every set.
